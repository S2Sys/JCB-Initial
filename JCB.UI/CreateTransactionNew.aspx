<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CreateTransactionNew.aspx.cs" Inherits="JCB.UI.CreateTransactionNew" %>
                                    ...
                                    <table cellpadding="5" cellspacing="0" border="0">
                                        ...
                                        <tr>
                                            <td id="tdBC" align="left" runat="server">
                                                ...
                                                <asp:RequiredFieldValidator ControlToValidate="ctlBranch" Display="None" runat="server"
                                                    InitialValue="-- Select --" ID="RequiredFieldValidator9" ValidationGroup="add"
                                                    ErrorMessage="Branch Required">
                                                </asp:RequiredFieldValidator>
                                            </td>
                                            <td align="left">
                                                ...
                                                <asp:RequiredFieldValidator ControlToValidate="ctlProduct" Display="None" runat="server"
                                                    InitialValue="-- Select --" ID="RequiredFieldValidator10" ValidationGroup="add"
                                            ...
                                            <td align="left">
                                                ...
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator5" ControlToValidate="ctlQty"
                                                    ValidationGroup="add" Display="Dynamic" runat="server" ValidationExpression="^[1-9]+[0-9]*$"
                                            ...
                                            <td style="vertical-align: top; text-align: right;" valign="middle" align="right">
                                                ...
                                                <asp:LinkButton runat="server" ValidationGroup="add" ID="hlAdd" class="swap" OnClick="ItemAdded"
                                                    OnClientClick="javascript:return CheckStockCount();"><img src="Images/Icons/Add_on.png" alt="Click here to add new Item?" /> Add</asp:LinkButton>
                                                <script>
            ...
            <table cellpadding="5" cellspacing="0" border="0" width="100%">
                                ...
                                <td>
                                    <table cellpadding="5" cellspacing="0" border="0">
                                        <tr>
                                            ...
                                            <td align="left" id="tdInvoice_0" runat="server">
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <asp:DropDownList runat="server" ID="ctlMode" AutoPostBack="True" OnSelectedIndexChanged="modeChanged">
                                                </asp:DropDownList>
                                            ...
                                            <td align="left" id="tdPRN_1" runat="server">
                                            ...
                                            <td align="left">
                                                <asp:DropDownList runat="server" ID="ctlSupplier" AutoPostBack="True" 
                                            ...
                                            <td class="formSubmit">
                                                <asp:Button ID="Button1" runat="server" Text="Save" ValidationGroup="save" OnClick="btnOrder_Click" />
                                            </td>
                                        </tr>
                        ...
                        <asp:GridView ID="gv" runat="server" AutoGenerateColumns="false" CellPadding="0"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Name" SortExpression="Product.Name">
                                    <ItemTemplate>
                                        <%# Eval("ProductGroup.Name")%>-<%# Eval("Product.Name")%>
                                    </ItemTemplate>
                                </asp:TemplateField>
                ...
                <tr>
                    <td align="right" class="formSubmit" style="text-align: right">
                        <asp:Button ID="btnOrder" runat="server" Text="Save" ValidationGroup="save" OnClick="btnOrder_Click" />
                    </td>
                </tr>
            </table>
