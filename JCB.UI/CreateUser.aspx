<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CreateUser.aspx.cs" Inherits="JCB.UI.CreateUser" %>
        ...
        <tr runat="server" id="trUsername">
            ...
            <td>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator3" ControlToValidate="ctlUsername"
                    runat="server" Text="Invalid" ValidationExpression="^([a-zA-Z0-9_-]{3,20})$" Display="Dynamic"
                    ValidationGroup="cmd" ErrorMessage="Invalid">
